...
function JeffersonApp() {
  ...
  const suggestionsByPhase = [
    ...
    ['J\'ai lu le brief, et après ?', 'Comment analyser les documents ?', 'Quels sont les signaux d\'alerte ?'],
    ['Comment écrire mon diagnostic à Sonia ?', 'Mon analyse est-elle assez précise ?', 'Quelle position adopter sur le go/no-go ?'],
    ['Comment remplir le livrable ?', 'Par quelle compétence commencer ?', 'Combien de temps me reste-t-il ?'],
